...
export const getDataInfo = createAsyncThunk('getDataInfo', async ({ searchQuery, currentPage, pageSize }) => {
    try {
        const response = await axios.get(`https://contact-list-backend-0zle.onrender.com/api/contacts/?searchQuery=${searchQuery}&currentPage=${currentPage}&pageSize=${pageSize}`,);
...
export const createContact = createAsyncThunk('createContact', async (data) => {
    try {
      const response = await axios.post('https://contact-list-backend-0zle.onrender.com/api/contacts',data);
...
export const getContactById = createAsyncThunk("getContactById", async (id) => {
    try {
        const response = await axios.get(`https://contact-list-backend-0zle.onrender.com/api/contacts/${id}`);
        return response.data;
    } catch (error) {
        throw error;
    }
...
export const editContact = createAsyncThunk("editContact", async ({ id, data }) => {
    try {
        const response = await axios.put(`https://contact-list-backend-0zle.onrender.com/api/contacts/${id}`, data);
        return response.data;
    } catch (error) {
        throw error;
    }
