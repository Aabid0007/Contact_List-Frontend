...
import { deleteContact } from '../../../../Redux/Reducer/GetData.Slice';
import { toast } from 'react-toastify';
import "./DeleteContact.css"

const DeleteContact = ({ deleteModalClose, contactId }) => {
        ...
        <>
            <div className='DeleteForm'>
                ...
                <div className="deleteFormSection">
                    ...
                    <div className='formSubmit'> <button type="submit" className="btn delete" onClick={deleteBtn}>
                        Delete
                    </button></div>
                </div>
            </div>
